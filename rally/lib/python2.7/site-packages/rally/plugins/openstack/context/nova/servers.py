...
class ServerGenerator(context.Context):
    ...
    CONFIG_SCHEMA = {
        ...
        "required": ["block_device_mapping_v2", "flavor", "name"],
        "additionalProperties": False
    }
    ...
    def setup(self):
        block_device_mapping_v2 = self.config["block_device_mapping_v2"]#change
        ...
        block_device_mapping_v2 = types.BlockDevice.transform(clients=clients,
                                               resource_config=block_device_mapping_v2)
        ...
        for iter_, (user, tenant_id) in enumerate(rutils.iterate_per_tenants(
            ...
            LOG.debug("Calling _boot_servers with block_device_mapping_v2=%(block_device_mapping_v2)s "
            ...
            servers = nova_scenario._boot_servers(block_device_mapping_v2, flavor_id,
