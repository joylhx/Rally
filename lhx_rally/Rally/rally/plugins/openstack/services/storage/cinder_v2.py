...
class CinderV2Service(service.Service, cinder_common.CinderMixin):
    ...
    def update_volume(self, volume, name=None, description=None):
        ...
        self._get_client().volumes.update(volume, **kwargs)
        updated_volume = self._get_client().volumes.get(volume.id)
    ...
    def create_volume_type(self, name=None, is_public=True):
        """create volume type.
